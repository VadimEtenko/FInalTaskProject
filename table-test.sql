...
MySQL - 8.0.25 : Database - hotel_test
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`hotel_test` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `booked_rooms`(`id`,`room_id`,`user_id`,`status_id`,`time_in`,`time_out`,`time_creating`,`is_paid`) values 
(52,1,2,1,'2021-06-16','2021-06-19','2021-06-16',1);
...
insert  into `offers`(`id`,`user_id`,`room_id`) values 
(10,2,4),
(11,2,6);
...
insert  into `request_wish`(`id`,`user_id`,`class_id`,`number_of_beds`,`time_in`,`time_out`) values 
(15,0,1,2,'2021-06-17','2021-06-17');
